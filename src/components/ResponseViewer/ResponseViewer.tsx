...
export function ResponseViewer() {
  return (
    <Container css={{ display: 'flex', flexWrap: 'nowrap', minHeight: 0, userSelect: 'none', flexDirection: 'column' }}>
      <Container css={{ display: 'flex', flexDirection: 'row' }}>
        <Text> Response </Text>
        <Switch color='success' icon={<FontAwesomeIcon icon={faCode}/>} />
      </Container>
      <Spacer />
      <ReactJson theme='bright' displayDataTypes={false} style={{ fontFamily: 'inherit', overflowY: 'auto'  }} src={{
